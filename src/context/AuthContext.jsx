...
export function AuthProvider({ children }) {
    ...
    const DEFAULT_PERMISSIONS = {
        ...
        sacristan: ['view_liturgy', 'view_calendar', 'view_sacristy', 'manage_sacristy', 'view_dashboard_sacristan', 'manage_communication'],
        musician: ['view_liturgy', 'view_calendar', 'view_music', 'manage_music', 'view_dashboard_musician', 'manage_communication'],
        acolyte: ['view_liturgy', 'view_calendar', 'view_dashboard_acolyte', 'manage_communication'],
