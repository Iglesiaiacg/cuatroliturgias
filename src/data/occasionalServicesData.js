export const serviceContent = {
    ...
    "Catecumenado": `
            <div class="liturgy-content">
                <h1>El Catecumenado</h1>
                <p class="rubric">El catecumenado es un tiempo de formación y maduración en la fe y en la vida cristiana.</p>
                <h3>Etapas del Camino</h3>
                <p>1. Precatecumenado: Tiempo de evangelización y primera conversión.</p>
                <p>2. Catecumenado: Tiempo de catequesis integral y ritos progresivos.</p>
                <p>3. Purificación e Iluminación: Tiempo de preparación espiritual intensa (Cuaresma).</p>
                <p>4. Mistagogia: Tiempo de profundización en los misterios de la fe (Pascua).</p>
                
                <h3>Oración por los Catecúmenos</h3>
                <p>Oremos.</p>
                <p>Mira, Señor, con bondad a tus siervos que buscan tu rostro; abre sus corazones a tu Espíritu Santo, para que, perseverando en la fe, encuentren el camino de la vida eterna. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
    "Admisión de Catecúmenos": `
            <div class="liturgy-content">
                <h1>Rito de Admisión al Catecumenado</h1>
                <p class="rubric">Se celebra a la entrada de la iglesia. Los candidatos esperan afuera.</p>
                
                <h3>Diálogo Inicial</h3>
                <p>Celebrante: ¿Qué pedís a la Iglesia de Dios?</p>
                <p><strong>Candidatos: La fe.</strong></p>
                <p>Celebrante: ¿Y qué os otorga la fe?</p>
                <p><strong>Candidatos: La vida eterna.</strong></p>
                
                <h3>Signación de los Sentidos</h3>
                <p class="rubric">El Celebrante marca a los candidatos con la señal de la cruz.</p>
                <p>Recibe la cruz en tu frente (+), para que Cristo mismo te proteja con la señal de su victoria. Aprende ahora a conocerle y a seguirle.</p>
                <p>Recibe la señal de la cruz en tus oídos (+), para que oigas la voz del Señor.</p>
                <p>Recibe la señal de la cruz en tus ojos (+), para que veas la claridad de Dios.</p>
                <p>Recibe la señal de la cruz en tus boca (+), para que respondas a la palabra de Dios.</p>
                <p>Recibe la señal de la cruz en tu pecho (+), para que Cristo habite por la fe en tu corazón.</p>
                <p>Recibe la señal de la cruz en tus espaldas (+), para que lleves el suave yugo de Cristo.</p>
                
                <p>Gloria al Padre, y al Hijo, y al Espíritu Santo. <strong>Amén.</strong></p>
                
                <p class="rubric">Los candidatos entran a la iglesia.</p>
            </div>
        `,
    "Inscripción de Candidatos": `
             <div class="liturgy-content">
                <h1>Inscripción de Candidatos</h1>
                <p class="rubric">Para aquellos ya bautizados que buscan completar su iniciación o ser recibidos en la comunión de esta Iglesia.</p>
                
                <h3>Acogida</h3>
                <p>Celebrante: La Iglesia reconoce con gozo vuestro bautismo. Ahora os invitamos a prepararos para recibir la plenitud de la gracia del Espíritu Santo y participar en la mesa del Señor.</p>
                
                <h3>Oración</h3>
                <p>Señor, te damos gracias porque ya has lavado a estos tus siervos en las aguas del renacimiento. Concédeles que, al prepararse para ser recibir la Confirmación o Recepción, crezcan en el conocimiento de tu misterio y den testimonio de su fe. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
             </div>
        `,
    "Entrega del Credo / Padre Nuestro": `
            <div class="liturgy-content">
                <h1>Tradición del Símbolo y del Padre Nuestro</h1>
                <p class="rubric">Se celebra durante el tiempo de la Purificación e Iluminación (Cuaresma).</p>
                
                <h3>Entrega del Credo</h3>
                <p class="rubric">Después de las lecturas, el Celebrante dice:</p>
                <p>Escuchad ahora las palabras de la fe por la cual recibiréis la justificación. Son pocas, pero encierran grandes misterios.</p>
                <p><strong>Creo en Dios Padre todopoderoso...</strong> (Se recita el Credo)</p>
                
                <h3>Entrega del Padre Nuestro</h3>
                <p class="rubric">En una celebración posterior:</p>
                <p>Nuestro Señor Jesucristo nos enseñó a orar. Recibid hoy la oración de los hijos de Dios.</p>
                <p><strong>Padre nuestro, que estás en el cielo...</strong></p>
                
                <p>Celebrante: Conservad estas palabras en vuestro corazón y meditadlas día y noche.</p>
            </div>
        `,
    "Vigilia Bautismal": `
             <div class="liturgy-content">
                <h1>Vigilia Bautismal</h1>
                <p class="rubric">Ritos preparatorios inmediatos (Rito del Effetá y Unción con los Óleos de los Catecúmenos) antes de la Vigilia Pascual o el día del Bautismo.</p>
                
                <h3>Rito del Effetá</h3>
                <p class="rubric">El Celebrante toca los oídos y la boca del candidato.</p>
                <p>Effetá, es decir, ábrete. Para que profeses tu fe para alabanza y gloria de Dios.</p>
                
                <h3>Unción Prebautismal</h3>
                <p class="rubric">Se unge el pecho o las manos con óleo de los catecúmenos.</p>
                <p>Que el poder de Cristo Salvador te fortalezca; quien vive y reina por los siglos de los siglos. <strong>Amén.</strong></p>
             </div>
        `,
    "Reafirmación Votos": `
            <div class="liturgy-content">
                <h1>Reafirmación de los Votos Bautismales</h1>
                <p class="rubric">Para aquellos que regresan a la práctica activa de la fe.</p>
                
                <h3>Renuncio y Creo</h3>
                <p>Celebrante: ¿Renunciáis a Satanás y a todas sus obras?</p>
                <p><strong>Candidato: Renuncio a ellos.</strong></p>
                <p>Celebrante: ¿Creéis en Dios Padre...?</p>
                <p><strong>Candidato: Creo.</strong></p>
                
                <h3>Oración</h3>
                <p>Todopoderoso Dios, te damos gracias porque nos has dado una nueva vida por el agua y el Espíritu. Renueva en este tu siervo la gracia del bautismo, para que permanezca fiel a tu alianza. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
    "Recepción de Miembros": `
            <div class="liturgy-content">
                <h1>Recepción de Miembros de otras Comuniones</h1>
                <p class="rubric">Para recibir a cristianos bautizados de otras tradiciones.</p>
                
                <h3>Reconocimiento</h3>
                <p>Celebrante: [Nombre], te reconocemos como miembro del Cuerpo de Cristo y te damos la bienvenida a la comunión de esta Iglesia.</p>
                
                <h3>Promesa</h3>
                <p>Candidato: Creo y profeso la fe cristiana como es enseñada en las Sagradas Escrituras y resumida en el Credo.</p>
                
                <h3>Acogida</h3>
                <p>Celebrante: Te recibimos en esta familia de Dios. Confiesa la fe de Cristo, proclama su resurrección y comparte con nosotros su misión.</p>
                <p><strong>Pueblo: Amén. Te damos la bienvenida.</strong></p>
            </div>
        `,
    "Inscripción Cuaresmal": `
            <div class="liturgy-content">
                <h1>Rito de Elección (Inscripción Cuaresmal)</h1>
                <p class="rubric">Se celebra el Primer Domingo de Cuaresma. Los catecúmenos son llamados "Elegidos".</p>
                
                <h3>Llamamiento</h3>
                <p>Celebrante: Que pasen adelante aquellos que han de ser elegidos para los sacramentos de Pascua.</p>
                
                <h3>Inscripción del Nombre</h3>
                <p class="rubric">Los candidatos escriben su nombre en el Libro de los Elegidos.</p>
                <p>Celebrante: N., declaras ahora públicamente tu deseo de ser iniciado en la fe cristiana?</p>
                <p>Candidato: Sí, lo deseo.</p>
                
                <h3>Oración por los Elegidos</h3>
                <p>Señor Dios, mira a estos elegidos que han inscrito sus nombres. Concédeles que, al acercarse a las aguas del bautismo, sean renovados por tu Espíritu y vivan siempre como hijos de la luz. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
    "Padres y Padrinos": `
            <div class="liturgy-content">
                <h1>Oración por Padres y Padrinos</h1>
                <p class="rubric">Preparación espiritual para quienes presentarán niños al Bautismo.</p>
                
                <h3>Exhortación</h3>
                <p>El bautismo es un don de Dios y una responsabilidad. Ustedes se comprometen a educar a este niño en la fe de Cristo.</p>
                
                <h3>Oración</h3>
                <p>Oremos.</p>
                <p>Dios de toda familia, concede a estos padres y padrinos la sabiduría y el amor necesarios para guiar a este niño. Que por su palabra y ejemplo, este niño pueda un día confesar por sí mismo la fe que hoy profesan en su nombre. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
    "Liturgia Horas": `
            <div class="liturgy-content">
                <h1>Liturgia de las Horas</h1>
                <p class="rubric">Oficio Diario para la mañana (Laudes) y la tarde (Vísperas).</p>
                
                <hr/>
                <h2>Laudes (Oración de la Mañana)</h2>
                
                <h3>Apertura</h3>
                <p>Señor, abre mis labios.</p>
                <p><strong>Y mi boca proclamará tu alabanza.</strong></p>
                
                <h3>Salmo Invitatorio (Salmo 95)</h3>
                <p>Venid, aclamemos alegremente al Señor... (Se recita el salmo)</p>
                
                <h3>Himno</h3>
                <p class="rubric">Himno de la mañana apropiado.</p>
                
                <h3>Salmodia</h3>
                <p class="rubric">Se recitan los salmos correspondientes al día.</p>
                
                <h3>Lectura Bíblica</h3>
                <p class="rubric">Lectura breve o larga de la Escritura.</p>
                
                <h3>Benedictus (Cántico de Zacarías)</h3>
                <p>Bendito el Señor Dios de Israel...</p>
                
                <h3>Preces</h3>
                <p>Oremos al Señor por las necesidades del mundo...</p>
                <p><strong>Padre nuestro...</strong></p>
                
                <hr/>
                <h2>Vísperas (Oración de la Tarde)</h2>
                
                <h3>Apertura</h3>
                <p>Dios mío, ven en mi auxilio.</p>
                <p><strong>Señor, date prisa en socorrerme.</strong></p>
                
                <h3>Himno</h3>
                <p class="rubric">Himno de la tarde (ej. "¡Luz alegre!").</p>
                
                <h3>Salmodia</h3>
                <p class="rubric">Salmos de la tarde.</p>
                
                <h3>Magnificat (Cántico de María)</h3>
                <p>Mi alma glorifica al Señor...</p>
                
                <h3>Oración Final</h3>
                <p>Que el Señor nos bendiga, nos guarde de todo mal y nos lleve a la vida eterna. <strong>Amén.</strong></p>
            </div>
        `,
    "Santoral": `
            <div class="liturgy-content">
                <h1>El Santoral</h1>
                <p class="rubric">Conmemoración de los Santos y Héroes de la Fe.</p>
                
                <h3>Estructura de la Conmemoración</h3>
                <p class="rubric">Puede usarse dentro de la Liturgia de las Horas o de la Eucaristía.</p>
                
                <h3>Lectura Biográfica</h3>
                <p class="rubric">Se lee una breve biografía del santo del día.</p>
                
                <h3>Salmo de los Santos (Salmo 15 o Salmo 34)</h3>
                <p>Señor, ¿quién habitará en tu tabernáculo? ¿Quién morará en tu monte santo? <strong>El que anda en integridad y hace justicia...</strong></p>
                
                <h3>Oración (Colecta del Santo)</h3>
                <p>Oremos.</p>
                <p>Oh Dios todopoderoso, que nos has dado el ejemplo de tu siervo/a [Nombre] para nuestra edificación: Concédenos que, animada por su testimonio, tu Iglesia persevere en la fe y en el amor, y comparta tu gloria eterna. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
    "Sobre el Exorcismo": `
            <div class="liturgy-content">
                <h1>Sobre el Exorcismo</h1>
                <p class="rubric">Notas Pastorales y Disciplina</p>
                
                <h3>Naturaleza del Ministerio</h3>
                <p>El ministerio de liberar a las personas e influencias malignas es parte integral de la misión de la Iglesia, conferida por Cristo a sus apóstoles. Sin embargo, su ejercicio requiere gran discernimiento, prudencia y autorización.</p>
                
                <h3>Requisitos Morales</h3>
                <p>1. <strong>Autorización:</strong> Ningún sacerdote debe realizar un exorcismo mayor sin la licencia explícita del Obispo.</p>
                <p>2. <strong>Discernimiento:</strong> Se debe descartar primero cualquier causa médica, psicológica o psiquiátrica. Es imperativo trabajar con profesionales de la salud mental.</p>
                <p>3. <strong>Preparación:</strong> El ministro debe prepararse con oración y ayuno.</p>
                
                <h3>Oraciones de Liberación (Exorcismo Menor)</h3>
                <p class="rubric">Cualquier sacerdote puede orar por la liberación y protección de los fieles.</p>
                <p>Señor Jesucristo, Hijo del Dios vivo, te imploramos que protejas a tu siervo/a [Nombre] de toda influencia del maligno. Que tu luz disipe las tinieblas y tu paz reine en su corazón. Por la autoridad de tu Nombre, ordenamos a todo espíritu contrario que se aparte y no vuelva. <strong>Amén.</strong></p>
                
                <p class="rubric">Se recomienda el uso del agua bendita y la señal de la cruz.</p>
            </div>
        `,
    "Comisionamiento Laicos": `
            <div class="liturgy-content">
                <h1>Comisionamiento de Laicos para Ministerios</h1>
                <p class="rubric">Para lectores, catequistas, guardianes, músicos, etc.</p>
                
                <h3>Presentación</h3>
                <p>Sacerdote: Hermanos, hoy comisionamos a estas personas para el ministerio de [Nombre del Ministerio] en esta congregación.</p>
                
                <h3>Examen</h3>
                <p>Sacerdote: ¿Estáis dispuestos a asumir esta responsabilidad con humildad y fidelidad?</p>
                <p><strong>Candidatos: Estoy dispuesto.</strong></p>
                
                <h3>Oración y Bendición</h3>
                <p>Oremos.</p>
                <p>Mira con favor, oh Señor, a estos tus siervos. Dales el don de tu gracia para que cumplan con diligencia el ministerio que se les confía, sirviendo fielmente delante de ti para la edificación de tu Iglesia y la gloria de tu Nombre. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
                
                <p class="rubric">El sacerdote puede entregarles un símbolo de su oficio (Biblia, llaves, instrumento, etc.).</p>
            </div>
        `,
    "Dedicación Mobiliario": `
            <div class="liturgy-content">
                <h1>Dedicación de Mobiliario y Ornamentos</h1>
                <p class="rubric">Para bendecir nuevos objetos litúrgicos (cálices, manteles, cruces, etc.).</p>
                
                <h3>Oración</h3>
                <p>Oremos.</p>
                <p>Dios eterno, indignos somos de ofrecerte nada de lo nuestro, pero te suplicamos que aceptes bondadosamente este [Nombre del Objeto] que dedicamos hoy para el uso en tu santuario.</p>
                <p>Bendícelo (+) y santifícalo; y concede que aquellos que lo usen (o miren) sean elevados en espíritu hacia ti y crezcan en devoción y santidad. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
                
                <p class="rubric">Se rocía el objeto con agua bendita.</p>
            </div>
        `,
    "Discernimiento Misión": `
            <div class="liturgy-content">
                <h1>Discernimiento de una Misión</h1>
                <p class="rubric">Oración para un grupo que considera plantar una nueva iglesia.</p>
                
                <h3>Lectura</h3>
                <p class="rubric">Hechos 13:1-3 (El envío de Bernabé y Saulo)</p>
                
                <h3>Examen Comunitario</h3>
                <p>Líder: ¿Creemos que Dios nos llama a esta obra?</p>
                <p><strong>Pueblo: Oramos por guía y claridad.</strong></p>
                
                <h3>Oración</h3>
                <p>Oh Dios, que enviaste a tu Hijo a predicar la paz a los que estaban lejos y a los que estaban cerca: Concede que te busquemos con todo nuestro corazón, y si es tu voluntad formar aquí una nueva comunidad de fe, danos la valentía para obedecer tu llamado. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
    "Comisionamiento Plantador": `
            <div class="liturgy-content">
                <h1>Comisionamiento de un Plantador de Iglesias</h1>
                <p class="rubric">Envío oficial de un líder (clérigo o laico) para iniciar una nueva obra.</p>
                
                <h3>La Misión</h3>
                <p>Obispo/Rector: [Nombre], la Iglesia te confía hoy la tarea de sembrar la semilla del Evangelio en [Lugar].</p>
                
                <h3>Las Promesas</h3>
                <p>Plantador: Con la ayuda de Dios, proclamaré el Evangelio, administraré (o procuraré) los sacramentos y cuidaré del rebaño que Dios me confíe.</p>
                
                <h3>Oración de Envío</h3>
                <p>Te enviamos en el nombre de Cristo. Sé fuerte y valiente; no temas ni desmayes, porque el Señor tu Dios estará contigo dondequiera que vayas. <strong>Amén.</strong></p>
            </div>
        `,
    "Apertura Congregación": `
            <div class="liturgy-content">
                <h1>Apertura de una Nueva Congregación</h1>
                <p class="rubric">Primer servicio público oficial.</p>
                
                <h3>Declaración de Propósito</h3>
                <p>En el nombre de Dios, nos reunimos hoy para inaugurar la adoración pública en esta Iglesia de [Nombre], dedicada a la gloria de Dios y al servicio de su pueblo.</p>
                
                <h3>Lectura Fundacional</h3>
                <p class="rubric">Mateo 28:18-20</p>
                
                <h3>Oración por la Congregación</h3>
                <p>Oh Dios, haz que la puerta de este lugar sea ancha para recibir a todos los que necesitan amor y comunión humana, pero estrecha para cerrar el paso a toda envidia, orgullo y contienda. Haz que sea un umbral para tu reino eterno. <strong>Amén.</strong></p>
            </div>
        `,
    "Puesta aparte espacio": `
            <div class="liturgy-content">
                <h1>Puesta Aparte de un Espacio Secular</h1>
                <p class="rubric">Para bendecir un local alquilado, escuela o salón para uso litúrgico temporal.</p>
                
                <h3>Oración</h3>
                <p>Dios Omnipresente, aunque los cielos de los cielos no te pueden contener, te dignas habitar en medio de tu pueblo.</p>
                <p>Te rogamos que aceptes este lugar, que ahora separamos del uso común para la sagrada función de la adoración, la instrucción y la comunión.</p>
                <p>Limpia este espacio de toda impureza; y haz que la presencia de tu Espíritu Santo lo santifique, para que sea para nosotros una casa de oración y una puerta del cielo. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
    "Letanía por la Misión": `
            <div class="liturgy-content">
                <h1>Letanía por la Misión de la Iglesia</h1>
                <p class="rubric">Puede usarse en cualquier servicio centrado en el evangelismo.</p>
                
                <p>Por la santa Iglesia de Dios, para que sea llena de verdad y amor, y se halle sin mancha en el día de tu venida.</p>
                <p><strong>Te rogamos, óyenos, Señor.</strong></p>
                
                <p>Por todos los miembros de tu Iglesia, para que testifiquen de ti en su vida diaria con valentía y humildad.</p>
                <p><strong>Te rogamos, óyenos, Señor.</strong></p>
                
                <p>Por aquellos que aun no creen, y por aquellos que han perdido la fe.</p>
                <p><strong>Te rogamos, óyenos, Señor.</strong></p>
                
                <p>Para que envíes obreros a tu mies, y sostengas a los que plantan nuevas iglesias.</p>
                <p><strong>Te rogamos, óyenos, Señor.</strong></p>
                
                <p>Para que la luz de tu Evangelio brille en todas las naciones y disipe las tinieblas de la ignorancia y el odio.</p>
                <p><strong>Te rogamos, óyenos, Señor.</strong></p>
                
                <h3>Colecta</h3>
                <p>Oh Dios, de quien proceden todos los santos deseos: aviva en nosotros el celo por tu reino, para que no descansemos hasta que tu voluntad se haga en la tierra como en el cielo. Por Jesucristo nuestro Señor. <strong>Amén.</strong></p>
            </div>
        `,
};
