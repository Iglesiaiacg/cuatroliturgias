...
import RosterView from './components/Ministries/RosterView' // [NEW]
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden md:pb-0">
          ...
          {activeTab === 'directory' && (
            ...
            (checkPermission && checkPermission('view_directory')) ? (
              <div className="flex-1 flex flex-col w-full overflow-y-auto px-4 py-6 max-w-7xl mx-auto pb-24 md:pb-40">
