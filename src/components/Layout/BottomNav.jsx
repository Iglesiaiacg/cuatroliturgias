        ...
        <nav className="w-full glass-nav pb-safe pt-2 px-6 z-50 shrink-0">
            <div className="flex justify-between items-center max-w-md mx-auto h-16">
                <button
                    ...
                    className={`flex flex-col items-center justify-center gap-1 w-16 group ${activeTab === 'dashboard' ? 'text-primary' : 'text-gray-600 dark:text-gray-500'}`}
                >
                ...
                <button
                    ...
                    className={`flex flex-col items-center justify-center gap-1 w-16 group ${activeTab === 'calendar' ? 'text-primary' : 'text-gray-600 dark:text-gray-500'}`}
                >
                ...
                <button
                    ...
                    className={`flex flex-col items-center justify-center gap-1 w-16 group ${activeTab === 'favorites' ? 'text-primary' : 'text-gray-600 dark:text-gray-500'}`}
                >
                ...
                <button
                    ...
                    className={`flex flex-col items-center justify-center gap-1 w-16 group ${activeTab === 'generator' ? 'text-primary' : 'text-gray-600 dark:text-gray-500'}`}
                >
